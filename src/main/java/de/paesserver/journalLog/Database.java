...
public class Database {
    ...
    public void insertStar(JSONObject jsonObject){
        ...
        String query = "INSERT INTO STAR(timestamp,event,ScanType,BodyName,BodyID,Parents,StarSystem,SystemAddress,StarType,StellarMass,Radius,SurfaceTemperature,SemiMajorAxis,Eccentricity,OrbitalInclination,Periapsis,OrbitalPeriod,AscendingNode,MeanAnomaly,RotationPeriod,AxialTilt,WasDiscovered,WasMapped,AbsoluteMagnitude,DistanceFromArrivalLS,Age_MY,Luminosity,Subclass) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try (PreparedStatement statement = databaseConnection.prepareStatement(query)){
            ...
            //TODO Update if data set is already available
            e.printStackTrace();
    ...
    public void insertSystemSignal(JSONObject jsonObject){
        ...
        String query = "INSERT INTO SYSTEMSIGNAL(timestamp,event,SystemAddress,SignalName,SignalName_Localised,USSType,USSType_Localised,SpawningState,SpawningState_Localised,SpawningFaction,ThreatLevel,TimeRemaining,IsStation) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void insertSystem(JSONObject jsonObject){
        ...
        String query = "INSERT INTO SYSTEM (" +
                "timestamp,event,Taxi,Multicrew,StarSystem,SystemAddress,StarPos,SystemAllegiance,SystemEconomy,SystemEconomy_Localised,SystemSecondEconomy,SystemSecondEconomy_Localised,SystemGovernment,SystemGovernment_Localised,SystemSecurity,SystemSecurity_Localised,Population,Body,BodyID,BodyType,JumpDist,FuelUsed,FuelLevel,Factions,SystemFaction,Conflicts) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
